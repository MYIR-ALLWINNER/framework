...
export SYSROOT=$LICHEE_TOP_DIR/out/${LICHEE_IC}/${LICHEE_BOARD}/longan/buildroot/host/arm-buildroot-linux-gnueabi/sysroot
...
export CROSS_COMPILE_DIR=$LICHEE_TOP_DIR/out/${LICHEE_IC}/${LICHEE_BOARD}/longan/buildroot/host/opt/ext-toolchain/bin/
...
function qtmakeinstall
{
	...
	mkdir -p $QT_TARGET_DIR
        ...
        #cp gpu libs to target
	cp ${LICHEE_GPU_LIB}/lib* $QT_INSTALL_DIR/lib
