...
int encodeFile(EncodeParam* param, FILE* inFile, FILE* outFile)
{
...
#else
    packet.pAddrVir0 = (unsigned char*)malloc(oneFrameLen);
#endif
    ...
    while (frameIndex < totalFrameNum)
    {
        ...
        fread(packet.pAddrVir0, 1, oneFrameLen, inFile);
