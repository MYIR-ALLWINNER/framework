 ...
 */
void __CdxListAdd(struct CdxListNodeS *new_node, struct CdxListNodeS *prev, struct CdxListNodeS *next);
 ...
 */
void CdxListAdd(struct CdxListNodeS *new_node, struct CdxListS *list);

void CdxListAddBefore(struct CdxListNodeS *new_node, struct CdxListNodeS *pos);

void CdxListAddAfter(struct CdxListNodeS *new_node, struct CdxListNodeS *pos);

void CdxListAddTail(struct CdxListNodeS *new_node, struct CdxListS *list);
 ...
 */
 void CdxListReplace(struct CdxListNodeS *old, struct CdxListNodeS *new_node);

void CdxListReplaceInit(struct CdxListNodeS *old, struct CdxListNodeS *new_node);
