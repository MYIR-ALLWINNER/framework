...
typedef struct {
    /*it means the bitrate of moving frame*/
    unsigned int            uMaxBitRate;
    /*range[50,100], default:85*/
    unsigned int            uRatioChangeQp;
    /*
     range[1,10], the quality of static frame;
     1:worst quality(low bitrate), 10:best quality(high bitrate), default: 5;
     the bitrate of static frame is: static_bitrate = quality/10*uMaxBitRate.
    */
    int                     nQuality;
}VencVbrParam;
