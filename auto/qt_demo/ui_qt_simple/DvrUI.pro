...
unix:!macx: LIBS += -L$$PWD/$$LIBSDK_PATH/ -lsdk -L$$PWD/$$LIBSDK_PATH/libs/ -lsdk_compose -lsdk_disp  -lsdk_dvr  -lsdk_g2d -lsdk_player  -lsdk_tr \
-L../../../../tools/pack/chips/$$(LICHEE_CHIP)/hal/gpu/fbdev/lib/ -lGLESv2 \
             ...
             -lcdx_parser -lsubdecoder -lvideoengine -lvdecoder -lcdx_stream   -lvencoder -lVE   -lcdc_base -lMemAdapter -ladecoder -laencoder -lxmetadataretriever -lcdx_base -lrt -lpthread -lz -lcrypto -lssl -ltinyalsa
