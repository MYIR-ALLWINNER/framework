...
./configure --prefix=$CDX_INSTALL_DIR --host=$HOST CFLAGS="-D__ENABLE_ZLIB__ -g" CPPFLAGS="-D__ENABLE_ZLIB__ -g" LDFLAGS="-lcrypto -lz -L$CDX_TOP/external/lib64/$CDX_LIB -L$CDX_TOP/external/lib32/$CDX_LIB  -L$CDC_INSTALL_DIR/lib" 
make -j32
make install -j32
cd -
