...
int main(int argc, char** argv)
{
    ...
    //From now on, I will use "/mnt/" instead of used "writer:///mnt".
    strcpy((char*)encode_param.stream_file,        "/mnt/sdcard/DCIM/Camera/720p_h264.mp4");
    ...
    /******************************* Set H264 Parameters ****************************/
     /******************************* Set H265 Parameters ****************************/
    //h265Param.bEntropyCodingCABAC = 1;
    h265Param.nBitrate = encode_param.bit_rate;
    h265Param.nFramerate = encode_param.frame_rate;
    //h265Param.nCodingMode = VENC_FRAME_CODING;
    //h265Param.nMaxKeyInterval = encode_param.maxKeyFrame;
    ...
    */
    ...
    {
        VideoEncSetParameter(pVideoEnc, VENC_IndexParamH265Param, &h265Param);
        //int vbvSize = 4*1024*1024;
        //VideoEncSetParameter(pVideoEnc, VENC_IndexParamSetVbvSize, &vbvSize);
    }
