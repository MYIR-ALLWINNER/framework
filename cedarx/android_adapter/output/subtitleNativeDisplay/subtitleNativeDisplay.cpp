...
CedarXSubRender::CedarXSubRender()
{
    ...
    logd("CedarXSubRender::CedarXSubRender");
    mUserSetFontColor = 0;
    mUserSetFontSize  = 20;
    mUserSetFontStyle = 0;
    mUserSetYPercent  = 10;
...
{
    size_t      count;
    logd("CedarXSubRender::cedarxSubSetZorderTop!");
    count   = mCedarXSubs.size();
...
{
    size_t      count;
    logd("CedarXSubRender::cedarxSubSetZorderBottom!");
    count   = mCedarXSubs.size();
