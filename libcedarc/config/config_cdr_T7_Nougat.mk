...
## 8. for the function of VE frequency setup
#LOCAL_CFLAGS += -DCONF_VE_FREQ_ENABLE_SETUP

## 9. now, the function of openmax-di just work well on h6/h3/T7 platform.
LOCAL_CFLAGS += -DCONF_ENABLE_OPENMAX_DI_FUNCTION

## 10. config kernel bitwide value explicitly as 64 FOR DI process.
...
## 12: Deinterlace V2X Support // new just support in H6/T7
LOCAL_CFLAGS += -DCONF_DI_V2X_SUPPORT

## 13: If u want to perform di mulplex, enable it.
