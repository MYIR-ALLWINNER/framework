############################################
## configurations: IPC-V5-eyeseelinux
############################################
include $(TARGET_TOP)/middleware/media/LIBRARY/libcedarc/config/config_common.mk
...
include $(TARGET_TOP)/middleware/media/LIBRARY/libcedarc/config/config_static_compile.mk

TARGET_CFLAGS += ${LOCAL_CFLAGS}
